...
A reference plugin exists for **WordPress**. Hugo integration is planned, and the architecture supports any CMS that can call an HTTP API and embed HTML attributes. See the [CMS reference repository](https://github.com/ArcadeLabsInc/htmltrust-cms-reference) for details.
...
- Browse the [GitHub repositories](https://github.com/ArcadeLabsInc) for the spec, server, browser extension, and CMS plugins
