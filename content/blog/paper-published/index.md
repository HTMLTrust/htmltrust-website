...
- **[Canonicalization Libraries](https://github.com/HTMLTrust/htmltrust-canonicalization)** — JavaScript, Go, PHP, Rust, and Python implementations, all passing the same conformance suite
